...
export default {
    ...
    execute: async (message) => {
        ...
        // O Prisma lida com JSON. Se por acaso vier como string, fazemos o parse
        ...
        const maxLvl = 10; // Nível máximo para não quebrar a economia

        // O custo sobe $25.000 por nível
